...
summary: 예제 챗봇 애플리케이션을 설치 및 실행하여 기술 자료를 테스트하고 Workload Factory API를 사용하여 자체 생성 AI 애플리케이션을 생성하는 방법을 배울 수 있습니다. 
---
...
[role="lead"]
기술 자료를 구성, 활성화 및 게시한 후 외부 애플리케이션 개발자는 NetApp에서 제공하는 오픈 소스 예제 챗봇 애플리케이션을 구성 및 실행하여 기술 자료와 상호 작용하고 Workload Factory API를 사용하여 자체 생성 AI 애플리케이션을 생성하는 방법을 배울 수 있습니다.
